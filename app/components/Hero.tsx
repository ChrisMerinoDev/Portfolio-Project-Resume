...
const socials = [
  { label: "GitHub", href: portfolio.links.github, icon: "GH" },
  { label: "LinkedIn", href: portfolio.links.linkedin, icon: "LI" },
  { label: "YouTube", href: portfolio.links.youtube, icon: "YT" },
];
